<template>
    <div>
      <a-row class="topRow">
        ...
        <a-col class="mt-2" align="middle" :span="22">
          <h3>Download Most Popular Monthly Top Games</h3>
        </a-col>
      </a-row>
      <a-row>
        <a-table :columns="columns" :data-source="getGAMESData" bordered>
          ...
          <!-- <a slot="year">
            ...
            <a slot="link" slot-scope="obj">
              <a :href="obj.torrent" target="blank">Download Game</a>
            </a>
  ...
  export default {
    ...
    computed: {
      ...mapGetters("modules/data", ["getGAMESData"]),
    },
    data() {
      return {
        columns,
    ...
    methods: {
      ...mapActions("modules/data", ["gameData"]),
    },
  };
  </script>
